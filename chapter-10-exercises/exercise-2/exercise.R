...
salaries$received_raise <- salaries$salaries_2018 > salaries$salaries_2017
print(salaries)
...
nrow(salaries[salaries$received_raise == TRUE, ])
...
mean(salaries[salaries$received_raise == FALSE, "adjustments"])
